...
void loop(){
    ...
    if(k == interval*60) {
        ...
        dailylogger[hh][(mm/interval)] = secondlogger/k;
   
        Serial.print("average of last 4 mins NTU:");
        Serial.println(dailylogger[hh][(mm/interval)]);
        secondlogger = 0;
        k = 0;
        Serial.println();
