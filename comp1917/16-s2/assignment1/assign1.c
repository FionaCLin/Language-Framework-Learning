...
void analyseInputScore(int num [], char * display [], int scores[]) {
    ...
    for ( i = 1; i <= 6; i++ ) {
        ...
        if ( f[i] == 1 ) { 
            ...
            int diff2 = pow( f[i] - f[i + 1], 2 );
            int diff1 = pow( f[i] - f[i - 1], 2 );
        ...
        if ( f[i] == 2 ) {
            if( i != 1 && i != 6 ){
                ...
                int diff1 = pow( f[i + 2] - f[i + 1], 2 );
                int diff2 = pow( f[i + 3] - f[i + 2], 2 );
                if (diff1 == 0 && diff2 == 0 ) {
                    straight++;
                }
                ...
                int diff1 = pow( f[4] - f[3], 2 );
                int diff2 = pow( f[4] - f[5], 2 );
                if (diff1 == 0 && diff2 == 0 ) {
                    straight++;
                }
                if ( straight == 2 ) {
